...
export const INITIAL_PAYMENTS: PaymentVerificationRecord[] = [
  {
    payment_id: 'pay_9041',
    order_id: 'APX-2026-9041',
    project_id: 'proj_apex_01',
  ...
  {
    payment_id: 'pay_8812',
    order_id: 'APX-2026-8812',
    project_id: 'proj_apex_02',
    user_id: 'user_student_1',
    studentName: 'Aarav Sharma',
    studentEmail: 'aarav.sharma@iitd.ac.in',
    studentCollege: 'Delhi Technological University (DTU)',
    ...
    projectLevel: 'basic',
    amount: 350,
    utr_number: 'CARD_TXN_8812_STRIPE',
    payment_status: 'verified',
    submitted_at: getPastDate(8),
    verified_at: getPastDate(8),
    verified_by: 'Super Admin (Operations)',
    payment_method: 'card',
  ...
  {
    payment_id: 'pay_7734',
    order_id: 'APX-2026-7734',
    project_id: 'proj_apex_03',
    user_id: 'user_student_1',
    studentName: 'Aarav Sharma',
    studentEmail: 'aarav.sharma@iitd.ac.in',
    studentCollege: 'Delhi Technological University (DTU)',
    ...
    projectLevel: 'mini',
    amount: 450,
    utr_number: 'HDFC_NET_773419',
    payment_status: 'verified',
    submitted_at: getPastDate(3),
    verified_at: getPastDate(3),
    verified_by: 'Super Admin (Operations)',
  ...
  {
    payment_id: 'pay_6621',
    order_id: 'APX-2026-6621',
    project_id: 'proj_apex_04',
    user_id: 'user_student_1',
    studentName: 'Aarav Sharma',
    studentEmail: 'aarav.sharma@iitd.ac.in',
    studentCollege: 'Delhi Technological University (DTU)',
    ...
    invoice_number: 'INV-2026-6621'
  },
  {
    payment_id: 'pay_5510',
    order_id: 'APX-2026-5510',
    project_id: 'proj_apex_05',
    user_id: 'user_student_1',
    studentName: 'Aarav Sharma',
    studentEmail: 'aarav.sharma@iitd.ac.in',
    studentCollege: 'Delhi Technological University (DTU)',
    studentPhone: '+91 98765 43210',
    projectTitle: 'Java Spring Boot Library Management Assignment',
    category: 'java',
    serviceType: 'college-project',
    projectLevel: 'mini',
    amount: 400,
    ...
    submitted_at: getPastDate(1),
    rejected_at: getPastDate(1),
    rejected_by: 'Super Admin (Operations)',
    rejection_reason: 'UTR could not be verified in bank statement. Transferred amount was not reflected.',
    payment_method: 'manual_upi',
